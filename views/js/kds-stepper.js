  ...
  return {
    ...
    template: function () {
      return '' +
        ...
        '</md-button>' +
        '<span flex="none" style="margin-left:8px;"> {{ step.label ||  $kdsStepperCtrl.stepLabel + ($index+1) }}  </span>' +
        '<span flex style="height: 1px; background:rgba(0,0,0,.15); margin-left: 8px; margin-right: 8px;"></span> ' +
        '</kds-step-item>';
    },
  }
}
